...
I am a Software and AI Data Engineer with a Master's in Computer Engineering from the University of Toronto and a Bachelor's in Automation Engineering from McMaster University, specializing in AI, software development, and cloud computing. As an AI Web Application Research Associate at UofT, I developed responsive React web applications with Flask backends for real-time AI visualization, built APIs to fetch model outputs, implemented multi-agent LLM pipelines using Python and LangChain, and designed reliable ETL/ELT data pipelines and SQL-based data models on cloud platforms such as Azure to support scalable AI workflows. I am passionate about building scalable, data-driven systems and delivering efficient, production-ready data and AI solutions.
...
Project source code: [https://github.com/jarviscanada/jarvis_data_eng_KaiqiangZheng](https://github.com/jarviscanada/jarvis_data_eng_KaiqiangZheng)


**Cluster Monitor** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_KaiqiangZheng/tree/master/linux_sql)]: Developed a Linux cluster monitoring system for Jarvis' LCA team using Docker-contained PostgreSQL to store node performance data. Implemented Bash scripts to automate container lifecycle, database table creation, and data insertion from Linux hardware metrics. Scheduled one-minute interval data collection via crontab and conducted manual testing on GCP virtual machines running Rocky Linux 9. Leveraged Git for version control, centralizing monitoring and reducing manual overhead, enabling administrators to efficiently track system performance and resource usage across multiple clusters.

**Core Java Apps** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_KaiqiangZheng/tree/master/core_java)]:
      
  - JDBC App: Developed a stock quote management application that allows users to track their investments, buy, and sell stocks. The application integrates a real-time stock data REST API and stores stock information in a PostgreSQL database via JDBC. A command-line interface (CLI) was created for users to simulate transactions and monitor the performance of their portfolio. Additionally, SLF4J logging was implemented to capture and log any errors that occur during application execution. The project leveraged Maven for efficient dependency management, Docker for containerization and deployment, and was thoroughly tested with JUnit and Mockito to ensure reliability and high code quality throughout the development process.
...
**Equity Market ETL Pipeline** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_KaiqiangZheng/tree/master/equity-market-etl)]: Delivered an end-to-end batch ETL pipeline for U.S. equity and ETF market data using Apache Airflow and Apache Spark (PySpark), transforming raw ticker-level OHLCV files into analytics-ready datasets. Implemented a medallion architecture (Bronze / Silver / Gold) with schema enforcement, data quality validation, and enrichment using company metadata. Orchestrated ingestion, transformation, and validation workflows with Airflow, and optimized scalability through partitioned Parquet storage. Designed the pipeline to be CI/CD-ready with unit tests and containerized execution using Docker, enabling reproducible and production-aligned data processing.
...
**Sentiment Analysis for Customer Service Ticket Analysis** [[GitHub](https://github.com/KaiqiangZheng1/Customer-Sentiment-Analysis)]: Built and deployed a sentiment analysis application in Docker to classify customer service ticket sentiments. Integrated OpenAI API for text analysis and Gradio for an interactive web interface, enabling real-time visualization of sentiment trends and improving customer feedback insights.
...
**Design Technician, University of Toronto SG (2022-2023)**: Utilized software tools to code programs and perform calculations, creating accurate design drawings for engineers and ensuring compliance with specifications. Supported busbar design through programming to assist assembly processes. Managed administrative tasks including enrolling new employees and maintaining records, contributing to smooth operational workflows.


## Education
**University of Toronto (2024-2025)**, Master of Engineering, Electrical and Computer Engineering
- GPA: 3.83/4.0

**McMaster University (2019-2023)**, Bachelor of Engineering Technology, Automation Engineering
