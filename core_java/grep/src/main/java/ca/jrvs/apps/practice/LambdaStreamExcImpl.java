...
public class LambdaStreamExcImpl implements LambdaStreamExc {
  ...
  public <E> List<E> toList(Stream<E> stream) {
    //return stream.toList(); Above Java 16
  ...
  public Consumer<String> getLambdaPrinter(String prefix, String suffix) {
    return messages -> System.out.println(prefix + messages + suffix);
  }
  ...
  public static void main(String[] args) {
    LambdaStreamExc l = new LambdaStreamExcImpl();

    // Test uppercase
    l.toUpperCase("a", "hello", "xyz").forEach(System.out::println);

    // Test odd printer
    Consumer<String> p = l.getLambdaPrinter("odd:", "!");
    l.printOdd(l.createIntStream(0, 10), p);
    ...
    l.flatNestedInt(nested).forEach(System.out::println);
  }
